...
class MarketTest < Minitest::Test
  ...
  def test_it_can_show_vendors_by_what_they_sell
    market = Market.new("South Pearl Street Farmers Market")
  ...
  def test_it_can_return_a_sorted_item_list_of_all_vendor_stock
    market = Market.new("South Pearl Street Farmers Market")
  ...
  def test_it_can_show_total_quantities_of_all_items_sold_in_market
    market = Market.new("South Pearl Street Farmers Market")
